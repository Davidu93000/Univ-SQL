...
insert into SERVEUR values (50, 'Pizzi', '3 rue des lilas', 90000, 'BELFORT', '12/01/1976');
insert into SERVEUR values (51, 'Cathy', '25 av Roosevelt', 90100, 'DELLE', '05/04/1978');
insert into SERVEUR values (52, 'Totof', '46 grande rue', 90500, 'BAVILLIERS', '30/09/1984');
insert into SERVEUR values (53, 'Pilou', '5 impasse Martin', 90000, 'BELFORT', '17/08/1986');
insert into SERVEUR values (54, 'Alice', '15 rue de la barre', 95880, 'ENGHIEN', '13/03/1986');

insert into FACTURE values (1200, 1, 53, '01/02/2010');
insert into FACTURE values (1201, 5, 53, '01/02/2010');
insert into FACTURE values (1202, 3, 52, '01/02/2010');
insert into FACTURE values (1203, 5, 50, '01/02/2010');
insert into FACTURE values (1204, 4, 52, '02/02/2010');
insert into FACTURE values (1205, 1, 53, '02/02/2010');
insert into FACTURE values (1206, 3, 52, '02/02/2010');
insert into FACTURE values (1207, 5, 53, '02/02/2010');
insert into FACTURE values (1208, 7, 54, '02/02/2010');
